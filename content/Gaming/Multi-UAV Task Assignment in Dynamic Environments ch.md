+++
date = '2025-08-04T17:07:50+08:00'
draft = false
title = '动态环境下多无人机任务分配技术现状'
summary= "对2013年至2024年间多无人机系统中动态任务分配的最新解决方案进行了全面研究。同时，提出了一个比较框架，用以根据应变能力（responsiveness）、鲁棒性（robustness）和可扩展性（scalability）等指标，评估算法在应对现实世界动态条件时的表现。"
+++
